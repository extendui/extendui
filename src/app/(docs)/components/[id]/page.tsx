...
export default function ComponentPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex flex-col space-y-2 rounded-md bg-white p-8 px-4 pt-6 shadow-[inset_0_0_5px_rgba(0,0,0,0.1)] shadow-slate-400 dark:bg-zinc-800 dark:shadow-none">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-start justify-start text-left">
        ...
        <p className="text-lg font-tight tracking-tight text-slate-400">

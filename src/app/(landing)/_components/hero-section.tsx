        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center space-y-4 py-[22dvh] text-center">
          <div className="relative">
            <FadeUp delay={0.2} duration={0.8}>
              <h1 className="bg-linear-to-br from-black via-zinc-600 to-zinc-400 bg-clip-text text-center text-3xl font-bold tracking-tight sm:text-center sm:text-4xl md:text-6xl dark:from-white dark:via-neutral-200 dark:to-black/[0.6]">
                Welcome to Extend UI
              </h1>
            </FadeUp>
            <FadeUp delay={0.4} duration={0.8}>
              <p className="mx-2 mt-6 max-w-2xl text-base font-light tracking-tight sm:text-xl dark:text-zinc-300">

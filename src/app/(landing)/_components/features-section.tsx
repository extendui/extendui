...
const features = [
    {
        ...
        description: "Build your UI faster with our pre-built, customizable components.",
    },
    {
        icon: Zap,
        title: "Performance Optimized",
        description: "Enjoy improved application performance with our optimized component library.",
    },
    {
        icon: Globe,
        title: "Easy Integration",
        description: "Seamlessly integrate with your existing React and Next.js projects.",
    },
];

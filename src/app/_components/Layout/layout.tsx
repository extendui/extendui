...
export default function Layout({ sidebar, children }: Props) {
  return (
    <div className="container mx-auto flex pt-16">
      ...
      <main className="flex-1 mx-4 mb-9 flex flex-col space-y-2 rounded-xl bg-white  p-8 px-4 pt-6 shadow-md shadow-slate-400 dark:bg-zinc-800 dark:shadow-none">
        {children}
      </main>
    </div>
  );

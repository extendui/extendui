...
export default function Layout({ sidebar, children }: Props) {
  return (
    <div className="max-w-11xl mx-auto flex justify-between p-5 pt-8 sm:px-6 lg:px-8">
      ...
      <main className="mx-auto mt-2 mb-4 w-full flex-1 md:w-2/3 lg:w-3/4 xl:w-4/5">
        {children}
      </main>
    </div>
  );

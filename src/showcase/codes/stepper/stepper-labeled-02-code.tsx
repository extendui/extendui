export function getStepperLabeled02Code() {
    return `"use client";
                    ...
                    <Stepper.Item key={step} step={step}>
                        <Stepper.Trigger asChild>
                            <div className="flex flex-col items-center">
                                <div
                                    className={\`p-2 size-8 rounded-lg flex items-center justify-center text-gray-500 bg-muted group-data-[state=completed]/step:bg-accent group-data-[state=active]/step:bg-accent group-data-[state=completed]/step:text-white group-data-[state=active]/step:text-white\`}
                                >

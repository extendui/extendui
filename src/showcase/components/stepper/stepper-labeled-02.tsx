          ...
          <Stepper.Item key={step} step={step}>
            <Stepper.Trigger asChild>
              <div className="flex flex-col items-center">
                <div
                  className={`bg-muted group-data-[state=completed]/step:bg-accent group-data-[state=active]/step:bg-accent flex size-8 items-center justify-center rounded-lg p-2 text-gray-500 group-data-[state=active]/step:text-white group-data-[state=completed]/step:text-white`}
                >
                ...
                <div className="mt-2 w-32 space-y-1">
                  <Stepper.Title
                    className={`${
                      step <= activeStep ? 'text-accent' : 'text-gray-500'
                    } font-medium`}
                  >
                    {label}
                  </Stepper.Title>
                  <Stepper.Description
                    className={`max-sm:hidden ${
                      step <= activeStep ? 'text-accent' : 'text-gray-400'
                    } text-sm`}
                  >
                    {description}
                  </Stepper.Description>
...
StepperLabeled02.displayName = 'StepperLabeled02';

  ...
  'flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium',
  {
    variants: {
      variant: {
        ...
        outline:
          'border-2 border-muted text-muted-foreground data-[state=active]:bg-primary data-[state=completed]:bg-primary data-[state=active]:border-primary data-[state=completed]:border-primary data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground bg-transparent',
        dotted:
          'border-2 border-dotted border-muted text-muted-foreground data-[state=active]:bg-primary data-[state=completed]:bg-primary data-[state=active]:border-primary data-[state=completed]:border-primary data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground bg-transparent',
      },
    },
    defaultVariants: {
      variant: 'default',
  ...
  ({ asChild = false, className, children, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        {...(!asChild
          ? { onClick: () => setActiveStep(step), disabled: isDisabled }
          : {})}
        {...props}
      >
        {children}

...
interface InputSelectRightProps extends React.InputHTMLAttributes<HTMLInputElement> { }

export const InputSelectRight = React.forwardRef<HTMLInputElement, InputSelectRightProps>(
  ({ className, ...props }, ref) => {

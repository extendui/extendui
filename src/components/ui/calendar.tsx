  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "text-accent-foreground relative after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:w-1 after:h-1 after:bg-emerald-600 after:rounded-full",
        day_outside:

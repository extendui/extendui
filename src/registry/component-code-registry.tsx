...
export async function loadComponentCode({ componentName, state }: Props) {
  switch (componentName) {
    ...
    case 'ExpandingDotButton': {
      const { getButtonExpandingDotCode } = await import('@/showcase/codes/button/button-expanding-dot-code');
      return getButtonExpandingDotCode();
    }
    case 'PulsatingOutlineShadowButton': {
      const { getButtonPulsatingOutlineShadowCode } = await import('@/showcase/codes/button/button-pulsating-outline-shadow-code');
      return getButtonPulsatingOutlineShadowCode();
    }
    case 'FlipButtonX': {
      const { getButtonFlipXCode } = await import('@/showcase/codes/button/button-flipX-code');
      return getButtonFlipXCode();
    }
    case 'FlipButtonY': {
      const { getButtonFlipYCode } = await import('@/showcase/codes/button/button-flipY-code');
      return getButtonFlipYCode();
    }
    case 'SendingButton01': {
      const { getButtonSending01Code } = await import('@/showcase/codes/button/button-sending-01-code');
      return getButtonSending01Code();
    }
    case 'SendingButton02': {
      const { getButtonSending02Code } = await import('@/showcase/codes/button/button-sending-02-code');
      return getButtonSending02Code();
    }
    case 'ButtonSunscribe': {
      const { getButtonSubscribeCode } = await import('@/showcase/codes/button/button-subscribe-code');
      return getButtonSubscribeCode();
    }
    case 'ButtonSlide': {
      const { getButtonSlideCode } = await import('@/showcase/codes/button/button-slide-code');
    ...
    case 'InputSelectRight': {
      const { getInputSelectRightCode } = await import('@/showcase/codes/input/input-selectRight-code');
      return getInputSelectRightCode();
    }
    case 'InputSelectLeft': {
      const { getInputSelectLeftCode } = await import('@/showcase/codes/input/input-selectLeft-code');
      return getInputSelectLeftCode();
    }
    case 'InputButtonRight': {
      const { getInputButtonRightCode } = await import('@/showcase/codes/input/input-button-right-code');
      return getInputButtonRightCode();
    }
    case 'InputDecreaseIncrease': {
      const { getInputDecreaseIncreaseCode } = await import('@/showcase/codes/input/input-decrease-increase-code');
      return getInputDecreaseIncreaseCode();
    }
    case 'FileInput': {
      const { getInputFileCode } = await import('@/showcase/codes/input/input-file-code');
      return getInputFileCode();
    }
    case 'CreditCardInput': {
      const { getCreditCardInputCode } = await import('@/showcase/codes/input/input-credit-card-code');
      return getCreditCardInputCode();
    }
    /* Select */
    case 'Select': {
      const { getSelectCode } = await import('@/showcase/codes/select/ui-select-code');
      return getSelectCode();
    }
    case 'SelectExample': {
      const { getSelectExampleCode } = await import('@/showcase/codes/select/select-code');
      return getSelectExampleCode(state);
    }
    case 'SelectAvatarDescription': {
      const { getSelectAvatarDescriptionCode } = await import('@/showcase/codes/select/select-avatar-description-code');
      return getSelectAvatarDescriptionCode();
    }
    case 'SelectStatus': {
      const { getSelectStatusCode } = await import('@/showcase/codes/select/select-status-code');
      return getSelectStatusCode();
    }
    /* Command */
    case 'Command': {
      const { getCommandCode } = await import('@/showcase/codes/command/ui-command-code');
      return getCommandCode();
    }
    case 'CommandExample': {
      const { getCommandExampleCode } = await import('@/showcase/codes/command/command-code');
      return getCommandExampleCode(state);
    }
    case 'CommandAvatarDescription': {
      const { getCommandAvatarDescriptionCode } = await import('@/showcase/codes/command/command-avatar-description-code');
      return getCommandAvatarDescriptionCode();
    }
    /* Blocks */
    case 'PricingCard': {
      const { getPricingCardCode } = await import('@/showcase/codes/blocks/cards/pricing-card-01-code');
      return getPricingCardCode();
    }
    case 'PricingCard02': {
      const { getPricingCard02Code } = await import('@/showcase/codes/blocks/cards/pricing-card-02-code');
      return getPricingCard02Code();
    }
    case 'CreditCard01': {
      const { getCreditCard01Code } = await import('@/showcase/codes/blocks/cards/credit-card-01-code');
      return getCreditCard01Code();
    }
    case 'CreditCard02': {
      const { getCreditCard02Code } = await import('@/showcase/codes/blocks/cards/credit-card-02-code');
      return getCreditCard02Code();
    }
    case 'SignIn01': {
      const { getSignIn01Code } = await import('@/showcase/codes/blocks/forms/sign-in-01-code');
      return getSignIn01Code();
    }
    case 'SignIn02': {
      const { getSignIn02Code } = await import('@/showcase/codes/blocks/forms/sign-in-02-code');
